...
function getNewEvents(req, res) {
  console.log(`http://api.eventful.com/json/events/search?app_key=xZsJsxZbnKn2phn3&where=${req.params.lat || 51.507602},${req.params.lng || -0.127816}&within=${req.params.radius||5}&date=today&page_size=25&sort_order=popularity&include=popularity,categories&offset=${req.params.offset||0}&category=${req.params.categories||'music,comedy,festivals_parades,performing_arts,sports'}`);
  rp(`http://api.eventful.com/json/events/search?app_key=xZsJsxZbnKn2phn3&where=${req.params.lat || 51.507602},${req.params.lng || -0.127816}&within=${req.params.radius||5}&date=today&page_size=25&sort_order=popularity&include=popularity,categories&offset=${req.params.offset||0}&category=${req.params.categories||'music,comedy,festivals_parades,performing_arts,sports'}`)
